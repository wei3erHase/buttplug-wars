...
contract ButtPlugBadgeDescriptor {
    ...
    function _generateDescription(PositionParams memory _params) internal pure returns (string memory) {
    ...
    function _generateName(PositionParams memory _params) internal pure returns (string memory) {
        return string(
            abi.encodePacked(
                'Mean Finance DCA - ', _params.swapInterval, ' - ', _params.fromSymbol, unicode' ➔ ', _params.toSymbol
            )
        );
    }
    ...
    function _generateSVGBorderText(PositionParams memory _params) internal pure returns (string memory) {
    ...
    function _generateSVGCardMantle(PositionParams memory _params) internal pure returns (string memory) {
        return string(
            abi.encodePacked(
    ...
    function _generageSVGProgressArea(PositionParams memory _params) internal pure returns (string memory) {
        return string(
            abi.encodePacked(
    ...
    function _generateSVGPositionData(PositionParams memory _params) internal pure returns (string memory) {
